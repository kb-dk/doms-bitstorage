...
public interface Bitstorage {
     ...
     * @throws ChecksumFailedException if the provided checksum does not match the one calculated on the server
     * @throws CommunicationException on problems communicating with bitstorage
     * @throws FileAlreadyApprovedException if a file with that name has already been added to the bitstorage
     * @throws NotEnoughFreeSpaceException if there is not enough space for the file to be uploaded
     * @throws java.net.MalformedURLException if the filename cannot be made into an url
     */
     ...
     * @throws CommunicationException on problems communicating with bitstorage
     * @throws FileNotFoundException if the file was not found in the temporary storage
     */
     ...
     * @throws CommunicationException on problems communicating with bitstorage
     * @throws FileNotFoundException if the file was not found in the temporary storage
     * @throws NotEnoughFreeSpaceException if there was not enough free space in the storage
     * @throws ChecksumFailedException if the supplied checksum does not match the checksum of the file
    */
    public String approve(URL file, String md5)
            throws FileNotFoundException,CommunicationException,NotEnoughFreeSpaceException, ChecksumFailedException;
