...
public class FedoraBasicRestSpeaker {
    ...
    void createExternalDatastream(String pid,
                                  String ds,
                                  String url,
                                  String checksum) {
        HttpRequest create =
                new HttpPost("/fedora/objects/" + pid + "/datastreams/" +
                        ...
                        "&dsState=A&mimeType=application/octet-stream" +
    ...
    void createInlineDatastream(String pid,
        ...
        try {
            HttpEntity entity = invoke(modify);
            earth(entity);
        } catch (ResourceNotFoundException e) {
...
/*--------------------------------- Directs ---------------------------------*/
    ...
    HttpEntity invoke(HttpRequest request
            ...
            ResourceNotFoundException {
        try {
            HttpResponse result = getClient().execute(
                    host, request);
    ...
    private void earth(HttpEntity entity) {
        try {
