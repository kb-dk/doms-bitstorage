...
public class BitstorageScriptImpl implements Bitstorage {
     ...
     * @see #runcommand(java.io.InputStream, dk.statsbiblioteket.doms.bitstorage.lowlevel.backend.scriptimpl.BitstorageScriptImpl.ScriptCommand, java.lang.String...)
     *
     */
